      ...
      <Box sx={HomeContainerStyle}>
        <Box sx={HomeContentWrapperStyle}>
          <Box sx={{ flex: 1, minWidth: '300px' }}>
            ...
            <Typography variant="h5" color="text.secondary" sx={HomeSubheadingStyle}>
          ...
          <Box sx={{ flex: 1, minWidth: '300px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Box component="img" src={HeroImage} alt="Career opportunities illustration" sx={HomeImageStyle} />
          </Box>
        </Box>
      </Box>
    </Container>
