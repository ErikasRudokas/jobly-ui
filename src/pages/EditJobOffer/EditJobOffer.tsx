    ...
    <Box sx={containerStyle}>
      ...
      <Paper sx={paperStyle}>
        <Box component="form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <JobOfferFormDescription register={register} errors={errors} disabled={submitting} />

          <JobOfferFormDetails register={register} control={control} errors={errors} disabled={submitting} />

          <JobOfferFormContact register={register} errors={errors} disabled={submitting} />

          <EditJobOfferSkillSection selectedSkills={selectedSkills} onSkillsChange={handleSkillsChange} />
