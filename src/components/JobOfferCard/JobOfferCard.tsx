    ...
    <Paper sx={cardStyle} onClick={() => onClick(jobOffer.id)} elevation={0}>
      ...
      <Box sx={metaRowStyle}>
        ...
        <Box sx={metaItemStyle}>
          ...
          <Typography sx={{ fontSize: '0.85rem', color: 'text.secondary' }}>{jobOffer.location}</Typography>
        </Box>
        <Box sx={separatorStyle} />
        <Box sx={metaItemStyle}>
          <CategoryIcon sx={{ fontSize: '0.95rem' }} />
          <Typography sx={{ fontSize: '0.85rem', color: 'text.secondary' }}>{jobOffer.category.name}</Typography>
        </Box>
      </Box>
    </Paper>
  );
