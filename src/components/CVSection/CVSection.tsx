          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            ...
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">
                {cvId ? 'You have a CV ready to download.' : 'Upload your CV to begin applying for jobs.'}
              </Typography>
            </Box>
          </Box>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap' }}>
          ...
          {selectedFile && (
            <>
              ...
              <AppButton startIcon={<UploadFileIcon />} onClick={handleUpload} loading={uploading}>
