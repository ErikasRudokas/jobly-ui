          ...
          <Box key={item.id} sx={viewItemCardStyle}>
            <Box sx={viewItemHeaderStyle}>
              <Box sx={viewItemTitleContainerStyle}>
                <Typography sx={viewItemTitleStyle}>{item.degree || 'No degree'}</Typography>
              </Box>
              {item.startDate && (
            ...
            <Box sx={viewItemMetaContainerStyle}>
              ...
              <Typography sx={viewItemMetaTextStyle}>{item.institutionName || 'No institution name'}</Typography>
            </Box>
          </Box>
        ))}
      </Box>
