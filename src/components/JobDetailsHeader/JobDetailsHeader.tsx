  ...
  return (
    <Box sx={headerSectionStyle}>
      ...
      <Box sx={metaInfoRowStyle}>
        ...
        <Typography sx={bulletStyle}>•</Typography>
        <Typography sx={statusTextStyle(jobOffer.offerStatus)}>{jobOffer.offerStatus}</Typography>
        <Typography sx={bulletStyle}>•</Typography>
        <Typography sx={salaryTextStyle}>{formatSalary(jobOffer.salary)}</Typography>
      </Box>
    </Box>
  );
};
