...
export const useCategories = () => {
  ...
  const getAllCategories = async (): Promise<GetAllCategoriesResponse | null> => {
    ...
    setError(null);
    try {
      const response = await axiosInstance.get<GetAllCategoriesResponse>(buildApiUrl(CATEGORY_ENDPOINTS.GET_ALL));
  ...
  const getCategoryById = async (id: number): Promise<Category | null> => {
    ...
    setError(null);
    try {
      const response = await axiosInstance.get<Category>(buildApiUrl(CATEGORY_ENDPOINTS.GET_BY_ID(id)));
      return response.data;
    } catch (err) {
  ...
  const createCategory = async (data: CategoryCreateRequest): Promise<Category | null> => {
    ...
    setError(null);
    try {
      const response = await axiosInstance.post<Category>(buildApiUrl(CATEGORY_ENDPOINTS.CREATE), data);
      return response.data;
    } catch (err) {
  ...
  const updateCategory = async (id: number, data: CategoryUpdateRequest): Promise<Category | null> => {
    ...
    setError(null);
    try {
      const response = await axiosInstance.put<Category>(buildApiUrl(CATEGORY_ENDPOINTS.UPDATE(id)), data);
      return response.data;
    } catch (err) {
